...
quarterly_agg_df = aggregate_to_percentages(quarterly_agg_df, date_col='date', response_col='observable_1m')
print(quarterly_agg_df.head())

directEstimationsFileName = '../data/Observable_Inflation_1m.xlsx'
...
# Постройте графики
analyzer.plot_all(save_prefix='observable_1m')